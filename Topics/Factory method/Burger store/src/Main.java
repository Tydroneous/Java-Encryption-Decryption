class TestDrive {
    public static void main(String[] args) throws InterruptedException {
        BurgerStore chineseBurger = new BurgerStore();
        chineseBurger.orderBurger("Chinese");
        BurgerStore americanBurger = new BurgerStore();
        americanBurger.orderBurger("American");
        BurgerStore russianBurger = new BurgerStore();
        russianBurger.orderBurger("Russian");
